  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center bg-zinc-950 px-6 py-24 font-sans text-zinc-100">
      <main className="flex w-full max-w-2xl flex-col gap-10">
        ...
        <div className="flex items-center justify-between rounded-lg border border-emerald-800/50 bg-emerald-950/30 px-5 py-4">
          ...
          <form action={logout}>
            <button className="rounded-md border border-zinc-700 px-4 py-2 text-sm text-zinc-300 transition-colors hover:bg-zinc-800">
              Sign out
            </button>
          </form>
        </div>
